import 'package:application_1/AllPages/ExplorePages/filters.dart';
...
class GroceryShops extends StatelessWidget {
  GroceryShops({Key? key}) : super(key: key);
    ...
    return SafeArea(
      ...
      appBar: AppBar(
        flexibleSpace: CustomToolbar(
          title: "Search grocery store in your area",
          leading: IconButton(
            onPressed: () {
              Get.back();
            },
                                  ...
                                  child: TextFormField(
                                    ...
                                    onChanged: (value) {
                                      if (value.isEmpty) {
                                        ...
                                        filterList(
                                            _controller.restaurantList.value,
                                            value);
                                      }
                                    },
