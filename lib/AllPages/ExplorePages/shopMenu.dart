import 'package:application_1/AllPages/ExplorePages/restaurant_menu_screen.dart';
...
class ShopMenu extends StatelessWidget {
  ...
  getAddress() {
    if (_controller.restaurantProfileModel.value.restaurantPfrofileData ==
        null) {
      return "";
    }
    return _controller
        .restaurantProfileModel.value.restaurantPfrofileData.address;
  }
  ...
  getName() {
    ...
    return _controller.restaurantProfileModel.value.restaurantPfrofileData.name;
  }
