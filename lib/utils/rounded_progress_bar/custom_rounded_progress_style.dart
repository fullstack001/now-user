...
const Color backgroundProgressDefault = Color(0xFFE0E0E0);
const Color colorProgressDefault = Color(0xFFFF9E45);
const Color colorProgressDarkDefault = Color(0xFFFF9E45);
const Color colorBorderDefault = Color(0xFFEEEEEE);

const Color colorProgressBlue = Color(0xFFFF9E45);
const Color colorProgressBlueDark = Color(0xFFFF9E45);
